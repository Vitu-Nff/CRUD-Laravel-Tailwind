    ...
    <div class="container px-5 py-24 mx-auto">
        ...
        <div class="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
            <a class="text-indigo-400 inline-flex items-center md:mb-2 lg:mb-0">Ver mais
                ...
                <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">  <a href="{{url('admin/add/')}}">Adicionar</a> </button>
        </div>
    </div>
</section>
@endsection
